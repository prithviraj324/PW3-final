...
import 'package:TimeTrack/blocs/projects/projects_bloc.dart';
import 'package:TimeTrack/blocs/settings/bloc.dart';
import 'package:TimeTrack/blocs/settings/settings_bloc.dart';
import 'package:TimeTrack/blocs/timers/bloc.dart';
import 'package:TimeTrack/components/ProjectColour.dart';
import 'package:TimeTrack/l10n.dart';
import 'package:TimeTrack/models/project.dart';
import 'package:TimeTrack/models/project_description_pair.dart';
import 'package:TimeTrack/models/timer_entry.dart';
import 'package:TimeTrack/screens/export/components/ExportMenu.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
          ...
          onPressed: () async {
            ...
            final String localPath = '${directory.path}/TimeTrack.csv';
            ...
            await Share.shareFiles(<String>[localPath],
                ...
                subject: L10N
                    .of(context)
                    .tr
                    .TimeTrackEntries(_dateFormat.format(DateTime.now())));
          }),
    );
  }
}
