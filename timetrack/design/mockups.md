...
Crudely drawn with http://asciiflow.com/, these are mockups that were created to explore what the interface of _Time Track_ should look like. It hasn't ended up looking exactly like these mockups imply, but for the most part its fairly close.
